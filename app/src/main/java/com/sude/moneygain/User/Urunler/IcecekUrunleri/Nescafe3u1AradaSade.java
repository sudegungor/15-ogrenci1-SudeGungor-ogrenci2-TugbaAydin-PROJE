...
public class Nescafe3u1AradaSade extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Nescafe_3_In_1_Tek_Icimx_18_Grx";
    private static String URL2 ="https://www.a101.com.tr/market/nescafe-kahve-3-u-1-arada-175-g/";
    private static String URL3 ="https://www.carrefoursa.com/nescafe-3u1-arada-sade-17-5-g-p-30005768";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Nescafe 3ü1 Arada Sade || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Nescafe 3ü1 Arada Sade || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Nescafe 3ü1 Arada Sade || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Nescafe 3ü1 Arada Sade || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Nescafe 3ü1 Arada Sade || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(Nescafe3u1AradaSade.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Nescafe 3ü1 Arada Sade || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "Nescafe3u1AradaSade"); //veri gönderiliyor
