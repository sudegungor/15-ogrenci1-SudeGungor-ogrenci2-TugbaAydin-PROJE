package com.sude.moneygain.User.Urunler.DeterjanUrunleri;
...
public class DomestosCamasirSuyuKarBeyazi extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Domestos_Ult_csuyu_810_Gr_Kar_Beyazi";
    private static String URL2 ="https://www.a101.com.tr/market/domestos-camasir-suyu-ultra-kar-beyazi-750-ml/";
    private static String URL3 ="https://www.carrefoursa.com/domestos-camasir-suyu-kar-beyazi-750-ml-p-30024717";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Domestos Çamaşır Suyu Kar Beyazı 750 ml || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Domestos Çamaşır Suyu Kar Beyazı 750 ml || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Domestos Çamaşır Suyu Kar Beyazı 750 ml || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Domestos Çamaşır Suyu Kar Beyazı 750 ml || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Domestos Çamaşır Suyu Kar Beyazı 750 ml || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(DomestosCamasirSuyuKarBeyazi.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Domestos Çamaşır Suyu Kar Beyazı 750 ml || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "DomestosCamasirSuyuKarBeyazi"); //veri gönderiliyor
