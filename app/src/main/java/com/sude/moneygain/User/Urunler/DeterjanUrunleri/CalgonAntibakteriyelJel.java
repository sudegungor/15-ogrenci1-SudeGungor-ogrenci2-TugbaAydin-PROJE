...
public class CalgonAntibakteriyelJel extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Product/?product_id=9611";
    private static String URL2 ="https://www.a101.com.tr/calgon-camasir-mak-tem-jeli-antibakteriyel-750-ml/";
    private static String URL3 ="https://www.carrefoursa.com/calgon-antibakteriyel-jel-750-ml-p-30253061";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Calgon Antibakteriyel Jel 750 ml || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Calgon Antibakteriyel Jel 750 ml || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Calgon Antibakteriyel Jel 750 ml || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Calgon Antibakteriyel Jel 750 ml || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Calgon Antibakteriyel Jel 750 ml || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(CalgonAntibakteriyelJel.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Calgon Antibakteriyel Jel 750 ml || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "CalgonAntibakteriyelJel"); //veri gönderiliyor
