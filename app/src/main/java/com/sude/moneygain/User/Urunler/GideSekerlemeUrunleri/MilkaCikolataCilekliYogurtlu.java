...
public class MilkaCikolataCilekliYogurtlu extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Milka_C__100_Gr_Tablet_Cilekli-yogurtlu";
    private static String URL2 ="https://www.a101.com.tr/market/milka-cikolata-cilekli-yogurtlu-100-g/";
    private static String URL3 ="https://www.carrefoursa.com/milka-cilekli-yogurtlu-cikolata-100-g-p-30098263";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Milka Çikolata Çilekli Yoğurtlu 100 G || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Milka Çikolata Çilekli Yoğurtlu 100 G || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Milka Çikolata Çilekli Yoğurtlu 100 G || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Milka Çikolata Çilekli Yoğurtlu 100 G || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Milka Çikolata Çilekli Yoğurtlu 100 G || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(MilkaCikolataCilekliYogurtlu.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Milka Çikolata Çilekli Yoğurtlu 100 G || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "MilkaCikolataCilekliYogurtlu"); //veri gönderiliyor
