...
public class Nescafe2si1Arada extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Nescafe_2_In_1_14_Gr";
    private static String URL2 ="https://www.a101.com.tr/market/nescafe-kahve-2-si-1-arada-10-g/";
    private static String URL3 ="https://www.carrefoursa.com/nescafe-2-si-1-arada-10-g-p-30071122";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Nescafe 2'si 1 Arada 10 g || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Nescafe 2'si 1 Arada 10 g || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Nescafe 2'si 1 Arada 10 g || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Nescafe 2'si 1 Arada 10 g || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Nescafe 2'si 1 Arada 10 g || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(Nescafe2si1Arada.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Nescafe 2'si 1 Arada 10 g || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "Nescafe2si1Arada"); //veri gönderiliyor
