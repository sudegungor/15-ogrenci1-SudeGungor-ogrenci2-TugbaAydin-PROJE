...
public class NestleNesquikKakaoluMisirGevregi310gr extends Activity {
    ...
    private static String URL1 = "https://www.happycenter.com.tr/Nesquik_310_Gr_Cokokare_Cikolatali_Gevrek";
    private static String URL2 = "https://www.a101.com.tr/market/nestle-misir-gevregi-cikolatali-310-g/";
    private static String URL3 = "https://www.carrefoursa.com/nestle-nesquik-duo-kakaolu-bugday-ve-misir-gevregi-310-gr-p-30022122";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2) {
        ...
        if(textView_isim.getText().equals("Nestle Mısır Gevreği Çikolatalı 310 G || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Nestle Mısır Gevreği Çikolatalı 310 G || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Nestle Mısır Gevreği Çikolatalı 310 G || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Nestle Mısır Gevreği Çikolatalı 310 G || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Nestle Mısır Gevreği Çikolatalı 310 G || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(NestleNesquikKakaoluMisirGevregi310gr.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Nestle Mısır Gevreği Çikolatalı 310 G || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "NestleMısırGevreğiÇikolatalı310G"); //veri gönderiliyor
