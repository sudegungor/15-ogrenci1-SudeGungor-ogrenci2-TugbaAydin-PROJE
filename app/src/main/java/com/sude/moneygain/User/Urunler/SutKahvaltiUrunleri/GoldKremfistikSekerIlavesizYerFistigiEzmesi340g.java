package com.sude.moneygain.User.Urunler.SutKahvaltiUrunleri;
...
import com.sude.moneygain.User.DetayliEkran;
...
public class GoldKremfistikSekerIlavesizYerFistigiEzmesi340g extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/gold-krem-fistik-sekersiz-yer-fistigi-ezmesi-340-gr";
    private static String URL2 ="https://www.a101.com.tr/market/gold-polmak-sekersiz-fistik-ezmesi-340-g/?recommended_by=instant_search&personaclick_search_query=gold%20krem%20fıstık%20şekersiz%20yer%20fıstığı%20ezmesi%20340%20gr";
    private static String URL3 ="https://www.carrefoursa.com/gold-kremfistik-seker-ilavesiz-yer-fistigi-ezmesi-340-g-p-30207138";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Gold Kremfıstık Şeker İlavesiz Yer Fıstığı Ezmesi 340 g || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Gold Kremfıstık Şeker İlavesiz Yer Fıstığı Ezmesi 340 g || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Gold Kremfıstık Şeker İlavesiz Yer Fıstığı Ezmesi 340 g || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Gold Kremfıstık Şeker İlavesiz Yer Fıstığı Ezmesi 340 g || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Gold Kremfıstık Şeker İlavesiz Yer Fıstığı Ezmesi 340 g || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(GoldKremfistikSekerIlavesizYerFistigiEzmesi340g.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Gold Kremfıstık Şeker İlavesiz Yer Fıstığı Ezmesi 340 g || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "goldKremfistikSekerIlavesizYerFistigiEzmesi340g"); //veri gönderiliyor
                    intent.putExtra("URL3", URL3); //veri gönderiliyor
                    startActivity(intent);

                    System.out.println("denemeeeeeeeeeeeeeeeeee"+liste_fiyat);
