package com.sude.moneygain.User.Urunler.GideSekerlemeUrunleri;
...
public class LaysYogurtMevsimYesillikleriPatatesCipsi extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Frito_Lays_110_Gr_Yogurt_Mevsim_Yesillikleri";
    private static String URL2 ="https://www.a101.com.tr/market/lays-firindan-patates-cipsi-mevsim-yesillikleri-96-g/";
    private static String URL3 ="https://www.carrefoursa.com/lay-s-yogurt-ve-mevsim-yesillikleri-cesnili-patates-cipsi-super-boy-107-gr-p-30084129";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Lays Fırından Patates Cipsi Mevsim Yeşillikleri 96 G || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Lays Fırından Patates Cipsi Mevsim Yeşillikleri 96 G || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Lays Fırından Patates Cipsi Mevsim Yeşillikleri 96 G || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Lays Fırından Patates Cipsi Mevsim Yeşillikleri 96 G || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Lays Fırından Patates Cipsi Mevsim Yeşillikleri 96 G || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(LaysYogurtMevsimYesillikleriPatatesCipsi.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Lays Fırından Patates Cipsi Mevsim Yeşillikleri 96 G || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "LaysYogurtMevsimYesillikleriPatatesCipsi"); //veri gönderiliyor
