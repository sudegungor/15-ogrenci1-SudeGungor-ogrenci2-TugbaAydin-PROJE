...
public class PinarProteinLaktozsuzKakaoluSut500ml extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Pinar_Sut_11_Extra_Light";
    private static String URL2 ="https://www.a101.com.tr/market/pinar-sut-proteinli-kakaolu-03-yagli-500-ml/";
    private static String URL3 ="https://www.carrefoursa.com/pinar-protein-laktozsuz-kakaolu-sut-500-ml-p-30177338";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Pınar Protein Laktozsuz Kakaolu Süt 500 ml || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Pınar Protein Laktozsuz Kakaolu Süt 500 ml || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Pınar Protein Laktozsuz Kakaolu Süt 500 ml || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Pınar Protein Laktozsuz Kakaolu Süt 500 ml || HappyCenter");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(PinarProteinLaktozsuzKakaoluSut500ml.this);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "pinar_protein_laktozsuz_kakaolu_sut_500_ml"); //veri gönderiliyor
