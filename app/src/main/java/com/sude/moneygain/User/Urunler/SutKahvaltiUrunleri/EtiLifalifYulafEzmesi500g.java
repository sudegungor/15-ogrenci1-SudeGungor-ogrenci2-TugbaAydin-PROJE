...
public class EtiLifalifYulafEzmesi500g extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Eti_G__500_Gr_Yulaf_Ezmesi_Lifalif_16950";
    private static String URL2 ="https://www.a101.com.tr/market/eti-lifalif-yulaf-ezmesi-500-g/";
    private static String URL3 ="https://www.carrefoursa.com/eti-lifalif-yulaf-ezmesi-500-g-p-30023663";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Eti Lifalif Yulaf Ezmesi 500 g || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Eti Lifalif Yulaf Ezmesi 500 g || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Eti Lifalif Yulaf Ezmesi 500 g || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Eti Lifalif Yulaf Ezmesi 500 g || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Eti Lifalif Yulaf Ezmesi 500 g || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(EtiLifalifYulafEzmesi500g.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Eti Lifalif Yulaf Ezmesi 500 g || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "EtiLifalifYulafEzmesi500g"); //veri gönderiliyor
