...
public class SleepyNaturalCocukBezi extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/sleepy-cocuk-bezi-pepe-kulot-bez-maxi-30-lu";
    private static String URL2 ="https://www.a101.com.tr/anne-bebek/sleepy-natural-cocuk-bezi-maxi-27-li/";
    private static String URL3 ="https://www.carrefoursa.com/sleepy-natural-4-beden-30-lu-p-30138418";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Sleepy Natural 4 Beden 30'lu || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Sleepy Natural 4 Beden 30'lu || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Sleepy Natural 4 Beden 30'lu || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Sleepy Natural 4 Beden 30'lu || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                Elements fiyat = doc.select("div[class='price single left']");
                ...
                liste_fiyat.add(fiyat.text().substring(0, fiyat.text().length()-5));

                liste_isim.add("Sleepy Natural 4 Beden 30'lu || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(SleepyNaturalCocukBezi.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Sleepy Natural 4 Beden 30'lu || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "SleepyNaturalCocukBezi"); //veri gönderiliyor
