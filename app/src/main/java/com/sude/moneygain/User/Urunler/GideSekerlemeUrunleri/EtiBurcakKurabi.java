...
public class EtiBurcakKurabi extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Eti_B__198_Gr_Kurabi_Yulafli_Kakaolu_17346";
    private static String URL2 ="https://www.a101.com.tr/market/eti-burcak-kurabi-198-g/";
    private static String URL3 ="https://www.carrefoursa.com/eti-burcak-kurabi-yulafli-kakao-198-gr-p-30189615";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Eti Burçak Kurabi 198 G || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Eti Burçak Kurabi 198 G || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Eti Burçak Kurabi 198 G || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Eti Burçak Kurabi 198 G || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Eti Burçak Kurabi 198 G || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(EtiBurcakKurabi.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Eti Burçak Kurabi 198 G || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "EtiBurcakKurabi"); //veri gönderiliyor
