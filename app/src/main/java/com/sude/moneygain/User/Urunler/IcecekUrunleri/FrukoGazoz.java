package com.sude.moneygain.User.Urunler.IcecekUrunleri;
...
public class FrukoGazoz extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Fruko_330_Ml_Gazoz_Kutu";
    private static String URL2 ="https://www.a101.com.tr/market/fruko-gazoz-330-ml/?recommended_by=instant_search&personaclick_search_query=fruko";
    private static String URL3 ="https://www.carrefoursa.com/fruko-gazoz-karisik-meyve-aromali-gazoz-kutu-33-cl-p-30056928";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Fruko Gazoz Karışık Meyve Aromalı Gazoz Kutu 33 cl || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Fruko Gazoz Karışık Meyve Aromalı Gazoz Kutu 33 cl || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Fruko Gazoz Karışık Meyve Aromalı Gazoz Kutu 33 cl || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Fruko Gazoz Karışık Meyve Aromalı Gazoz Kutu 33 cl || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Fruko Gazoz Karışık Meyve Aromalı Gazoz Kutu 33 cl || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(FrukoGazoz.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Fruko Gazoz Karışık Meyve Aromalı Gazoz Kutu 33 cl || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "FrukoGazoz"); //veri gönderiliyor
