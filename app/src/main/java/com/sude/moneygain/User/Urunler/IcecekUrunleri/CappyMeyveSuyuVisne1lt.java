...
public class CappyMeyveSuyuVisne1lt extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Cappy_1_Lt_M_suyu_Visne";
    private static String URL2 ="https://www.a101.com.tr/market/cappy-visne-meyve-nektari-1-l/";
    private static String URL3 ="https://www.carrefoursa.com/cappy-visne-tetra-1-l-p-30214086";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Cappy Meyve Suyu Vişne 1 lt || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Cappy Meyve Suyu Vişne 1 lt || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Cappy Meyve Suyu Vişne 1 lt || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Cappy Meyve Suyu Vişne 1 lt || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Cappy Meyve Suyu Vişne 1 lt || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(CappyMeyveSuyuVisne1lt.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Cappy Meyve Suyu Vişne 1 lt || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "CappyMeyveSuyuVisne1lt"); //veri gönderiliyor
