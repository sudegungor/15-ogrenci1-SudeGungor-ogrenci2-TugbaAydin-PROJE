...
public class UlkerBiskremKakaoluBiskuviBuyuk extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Ulker_B__1150_1_Biskrem_Poset_Kakaolu_190_Gr";
    private static String URL2 ="https://www.a101.com.tr/market/ulker-biskrem-biskuvi-cikolata-dolgulu-200-g/";
    private static String URL3 ="https://www.carrefoursa.com/ulker-biskrem-kakaolu-biskuvi-buyuk-boy-poset-200-g-p-30126881";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Ülker Biskrem Bisküvi Çikolata Dolgulu 200 G || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Ülker Biskrem Bisküvi Çikolata Dolgulu 200 G || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Ülker Biskrem Bisküvi Çikolata Dolgulu 200 G || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Ülker Biskrem Bisküvi Çikolata Dolgulu 200 G || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Ülker Biskrem Bisküvi Çikolata Dolgulu 200 G || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(UlkerBiskremKakaoluBiskuviBuyuk.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Ülker Biskrem Bisküvi Çikolata Dolgulu 200 G || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "UlkerBiskremKakaoluBiskuviBuyuk"); //veri gönderiliyor
