...
public class AnavarzaCicekBali850g extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Anavarza_850_Gr_Cicek_Bali";
    private static String URL2 ="https://www.a101.com.tr/market/anavarza-cicek-bali-850-g/";
    private static String URL3 ="https://www.carrefoursa.com/anavarza-cicek-bali-850-g-p-30195605";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Anavarza Çiçek Balı 850 g || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Anavarza Çiçek Balı 850 g || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Anavarza Çiçek Balı 850 g || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Anavarza Çiçek Balı 850 g || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Anavarza Çiçek Balı 850 g || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(AnavarzaCicekBali850g.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Anavarza Çiçek Balı 850 g || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "anavarza_cicek_bali_850g"); //veri gönderiliyor
