...
public class Deterjan extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deterjan);
    ...
    private void navigationDrawer() {
        ...
        navigationView.setCheckedItem(R.id.nav_Temizlik);
    ...
    private void rec_urunler1(){
        ...
        recUrunlerHelperClasses.add(new RecUrunlerHelperClasses(R.drawable.calgon_antibakteriyel_jel_750_ml, "Calgon Antibakteriyel Jel 750 ml", R.drawable.persil_jel_camasir_deterjani, "Persil Sıvı Çamaşır Deterjanı 2310 Ml"));
        recUrunlerHelperClasses.add(new RecUrunlerHelperClasses(R.drawable.domestos_camasir_suyu_kar_beyazi, "Domestos Çamaşır Suyu Kar Beyazı 750 ml", R.drawable.cif_jel_tum_yuzeyler_cicek_ferahligi, "Cif Jel Tüm Yüzeyler Çiçek Ferahlığı 750 ml"));
