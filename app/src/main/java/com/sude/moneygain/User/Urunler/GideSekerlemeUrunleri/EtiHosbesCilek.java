...
public class EtiHosbesCilek extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Eti_B__160_Gr_Hosbes_Cilek_Kremali_Gofret_19526";
    private static String URL2 ="https://www.a101.com.tr/market/eti-hosbes-gofret-cilekli-142-g/?recommended_by=instant_search&personaclick_search_query=eti%20hooşbeş";
    private static String URL3 ="https://www.carrefoursa.com/eti-hosbes-cilekli-gofret-142-g-p-30085870";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Eti Hoşbeş Çilekli Gofret 142 g || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Eti Hoşbeş Çilekli Gofret 142 g || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Eti Hoşbeş Çilekli Gofret 142 g || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Eti Hoşbeş Çilekli Gofret 142 g || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Eti Hoşbeş Çilekli Gofret 142 g || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(EtiHosbesCilek.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Eti Hoşbeş Çilekli Gofret 142 g || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "EtiHosbesCilek"); //veri gönderiliyor
