...
public class DanoneSutKakaolu180Ml extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Danone_Sut_15_Kakaolu";
    private static String URL2 ="https://www.a101.com.tr/market/danone-sut-kakaolu-180-ml/";
    private static String URL3 ="https://www.carrefoursa.com/danone-kakaolu-aromali-uht-sut-180-ml-p-30092080";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Danone Sut Kakaolu 180 Ml || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Danone Sut Kakaolu 180 Ml || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Danone Sut Kakaolu 180 Ml || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Danone Sut Kakaolu 180 Ml || HappyCenter");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(DanoneSutKakaolu180Ml.this);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "danonesutkakaolu180ml"); //veri gönderiliyor
