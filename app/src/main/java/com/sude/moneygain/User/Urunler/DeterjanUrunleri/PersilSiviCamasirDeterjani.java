...
public class PersilSiviCamasirDeterjani extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Persil_Jel_2_555_L_Gulun_Buyusu";
    private static String URL2 ="https://www.a101.com.tr/market/persil-sivi-camasir-deterjani-2310-ml/";
    private static String URL3 ="https://www.carrefoursa.com/persil-gulun-buyusu-jel-camasir-deterjani-33-yikama-p-30017549";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Persil Sıvı Çamaşır Deterjanı || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Persil Sıvı Çamaşır Deterjanı || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Persil Sıvı Çamaşır Deterjanı || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Persil Sıvı Çamaşır Deterjanı || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Persil Sıvı Çamaşır Deterjanı || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(PersilSiviCamasirDeterjani.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Persil Sıvı Çamaşır Deterjanı || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "PersilSiviCamasirDeterjani"); //veri gönderiliyor
