...
public class MarmaraBirlikKuruSeleZeytin400g extends Activity {
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Marmara Birlik Kuru Sele Zeytin 400 g || HappyCenter");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(MarmaraBirlikKuruSeleZeytin400g.this);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "marmara_birlik_kuru_sele_zeytin_400_g"); //veri gönderiliyor
