...
public class HariboAltinAyicik extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Haribo_200_Gr_Altin_Ayicik";
    private static String URL2 ="https://www.a101.com.tr/market/haribo-yumusak-seker-130-g-3/";
    private static String URL3 ="https://www.carrefoursa.com/haribo-altin-ayicik-160-g-p-30033845";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Haribo Altın Ayıcık || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Haribo Altın Ayıcık || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Haribo Altın Ayıcık || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Haribo Altın Ayıcık || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Haribo Altın Ayıcık || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(HariboAltinAyicik.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Haribo Altın Ayıcık || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "HariboAltinAyicik"); //veri gönderiliyor
