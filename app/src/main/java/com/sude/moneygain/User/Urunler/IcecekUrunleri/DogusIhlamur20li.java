...
public class DogusIhlamur20li extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Dogus_26_Gr_Cay_Bitki_Ihlamur_";
    private static String URL2 ="https://www.a101.com.tr/market/dogus-ihlamur-20-li/";
    private static String URL3 ="https://www.carrefoursa.com/dogus-ihlamur-cayi-20-li-p-30088490";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Doğuş Ihlamur Çayı 20'li || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Doğuş Ihlamur Çayı 20'li || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Doğuş Ihlamur Çayı 20'li || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Doğuş Ihlamur Çayı 20'li || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Doğuş Ihlamur Çayı 20'li || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(DogusIhlamur20li.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Doğuş Ihlamur Çayı 20'li || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "DogusIhlamur20li"); //veri gönderiliyor
