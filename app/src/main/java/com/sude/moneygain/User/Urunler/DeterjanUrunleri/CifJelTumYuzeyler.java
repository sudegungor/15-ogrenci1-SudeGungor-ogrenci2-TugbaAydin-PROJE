...
public class CifJelTumYuzeyler extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Cif_Jel__750_Ml_Banyo";
    private static String URL2 ="https://www.a101.com.tr/market/cif-banyo-mutfak-jel-temizleyici-cicek-ferahligi-750-ml/";
    private static String URL3 ="https://www.carrefoursa.com/cif-jel-tum-yuzeyler-cicek-ferahligi-750-ml-p-30126627";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Cif Jel Tüm Yüzeyler Çiçek Ferahlığı 750 ml || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Cif Jel Tüm Yüzeyler Çiçek Ferahlığı 750 ml || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Cif Jel Tüm Yüzeyler Çiçek Ferahlığı 750 ml || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Cif Jel Tüm Yüzeyler Çiçek Ferahlığı 750 ml || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Cif Jel Tüm Yüzeyler Çiçek Ferahlığı 750 ml || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(CifJelTumYuzeyler.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Cif Jel Tüm Yüzeyler Çiçek Ferahlığı 750 ml || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "CifJelTumYuzeyler"); //veri gönderiliyor
