...
public class PoweradeSporcuIcecegi500Ml extends Activity {
    ...
    private static String URL1 ="https://www.happycenter.com.tr/Powerade_500_Ml_Ice_Blast_Meyve_Aro_Mavi_Pet";
    private static String URL2 ="https://www.a101.com.tr/market/powerade-sporcu-icecegi-500-ml/";
    private static String URL3 ="https://www.carrefoursa.com/powerade-ice-blast-500-ml-p-30099535";
    ...
    public static void karsilastir(ArrayList<String> liste1, ArrayList<String> liste2){
        ...
        if(textView_isim.getText().equals("Powerade Ice Blast 500 ml || HappyCenter"))
            market_logo.setImageResource(R.drawable.happycenter_pic);

        else if(textView_isim.getText().equals("Powerade Ice Blast 500 ml || A101"))
            market_logo.setImageResource(R.drawable.a101_pic);

        else if(textView_isim.getText().equals("Powerade Ice Blast 500 ml || CarrefourSA"))
    ...
    private class HCVeriGetir extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Powerade Ice Blast 500 ml || HappyCenter");
    ...
    private class A101VeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Powerade Ice Blast 500 ml || A101");
    ...
    private class CarrefourVeriGetir extends AsyncTask<Void, Void, Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(PoweradeSporcuIcecegi500Ml.this);
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                liste_isim.add("Powerade Ice Blast 500 ml || CarrefourSA");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            detay_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("urun_adi", "PoweradeSporcuIcecegi500Ml"); //veri gönderiliyor
