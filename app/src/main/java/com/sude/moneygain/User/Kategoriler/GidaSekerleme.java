...
public class GidaSekerleme extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gida_sekerleme);
    ...
    private void navigationDrawer() {
        ...
        navigationView.setCheckedItem(R.id.nav_Gida);
    ...
    private void rec_urunler1(){
        ...
        recUrunlerHelperClasses.add(new RecUrunlerHelperClasses(R.drawable.lays_yogurt_mevsim_yesillikleri_cips, "Lays Fırından Patates Cipsi Mevsim Yeşillikleri 96 G", R.drawable.milka_cilekli_yogurtlu_tablet_cikolata, "Milka Çilekli Yoğurtlu Çikolata 100 g"));
        recUrunlerHelperClasses.add(new RecUrunlerHelperClasses(R.drawable.ulker_biskrem_biskuvi_cikolata_dolgulu, "Ülker Biskrem Bisküvi Çikolata Dolgulu 200 G", R.drawable.haribo_altin_ayicik, "Haribo Altın Ayıcık"));
        recUrunlerHelperClasses.add(new RecUrunlerHelperClasses(R.drawable.eti_hosbes_gofret_cilekli, "Eti Hoşbeş Çilekli Gofret 142 g", R.drawable.eti_burcak_kurabi, "Eti Burçak Kurabi 198 G"));
