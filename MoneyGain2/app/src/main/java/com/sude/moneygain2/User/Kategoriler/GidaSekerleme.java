...
public class GidaSekerleme extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void rec_urunler1(){
        ...
        recUrunlerHelperClasses.add(new RecUrunlerHelperClasses(R.drawable.lays_yogurt_mevsim_yesillikleri_cips, "Lays Fırından Patates Cipsi Mevsim Yeşillikleri 96 G", R.drawable.yudum_aycicek_2l, "Seker2"));
        recUrunlerHelperClasses.add(new RecUrunlerHelperClasses(R.drawable.happycenter_pic, "Seker3", R.drawable.cola_2_5, "Seker4"));
        recUrunlerHelperClasses.add(new RecUrunlerHelperClasses(R.drawable.yudum_aycicek_2l, "Seker5", R.drawable.happycenter_pic, "Seker6"));
