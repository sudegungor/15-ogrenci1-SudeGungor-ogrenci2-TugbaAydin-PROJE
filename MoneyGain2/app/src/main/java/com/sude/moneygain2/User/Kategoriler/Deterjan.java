...
public class Deterjan extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void rec_urunler1(){
        ...
        recUrunlerHelperClasses.add(new RecUrunlerHelperClasses(R.drawable.cola_2_5, "Coca Cola", R.drawable.yudum_aycicek_2l, "Sıvı Yağ"));
        recUrunlerHelperClasses.add(new RecUrunlerHelperClasses(R.drawable.happycenter_pic, "Happy Center", R.drawable.cola_2_5, "Coca C21321ola"));
        recUrunlerHelperClasses.add(new RecUrunlerHelperClasses(R.drawable.yudum_aycicek_2l, "Sıv21312ı Yağ", R.drawable.happycenter_pic, "Happy 231312Center"));
