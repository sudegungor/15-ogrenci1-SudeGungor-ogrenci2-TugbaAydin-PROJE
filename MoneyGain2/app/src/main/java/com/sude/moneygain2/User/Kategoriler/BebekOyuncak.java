...
public class BebekOyuncak extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    ...
    private void rec_urunler1(){
        ...
        recUrunlerHelperClasses.add(new RecUrunlerHelperClasses(R.drawable.cola_2_5, "Bebek1", R.drawable.yudum_aycicek_2l, "Bebek2"));
        recUrunlerHelperClasses.add(new RecUrunlerHelperClasses(R.drawable.happycenter_pic, "Bebek3", R.drawable.cola_2_5, "Bebek4"));
        recUrunlerHelperClasses.add(new RecUrunlerHelperClasses(R.drawable.yudum_aycicek_2l, "Bebek5", R.drawable.happycenter_pic, "Bebek6"));
