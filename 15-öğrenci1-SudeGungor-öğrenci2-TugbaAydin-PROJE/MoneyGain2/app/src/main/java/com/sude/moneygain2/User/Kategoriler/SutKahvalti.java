...
public class SutKahvalti extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sut_kahvalti);
    ...
    private void navigationDrawer() {
        ...
        navigationView.setCheckedItem(R.id.nav_Sut);
    ...
    private void rec_urunler1(){
        ...
        recUrunlerHelperClasses.add(new RecUrunlerHelperClasses(R.drawable.danone_sut_kakaolu_180_ml, "Danone Süt Kakaolu 180 Ml", R.drawable.eti_lifalif_yulaf_ezmesi_500g, "Eti Lifalif Yulaf Ezmesi 500 g"));
        recUrunlerHelperClasses.add(new RecUrunlerHelperClasses(R.drawable.nestle_misir_gevregi_cikolatali_310g, "Nestle Mısır Gevreği Çikolatalı 310 G", R.drawable.gold_kremfistik_seker_ilavesiz_yer_fistigi_ezmesi_340_g, "Gold Kremfıstık Şeker İlavesiz Yer Fıstığı Ezmesi 340 g"));
        recUrunlerHelperClasses.add(new RecUrunlerHelperClasses(R.drawable.pinar_protein_laktozsuz_kakaolu_sut_500_ml, "Pınar Protein Laktozsuz Kakaolu Süt 500 ml", R.drawable.anavarza_cicek_bali_850g, "Anavarza Çiçek Balı 850 g"));
        recUrunlerHelperClasses.add(new RecUrunlerHelperClasses(R.drawable.torku_banada_400_g, "Torku Banada 400 g", R.drawable.marmara_birlik_kuru_sele_zeytin_400_g, "Marmara Birlik Kuru Sele Zeytin 400 g Pet"));
